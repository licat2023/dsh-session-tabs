...
header:has(> div[role='tablist']) > div:first-child span{font-size:13px;line-height:16px;font-weight:500;align-items:flex-end}
header:has(> div[role='tablist']) > div:first-child button{min-width:0;height:auto;padding:0;border:none;border-radius:0;background:transparent;font-size:13px;line-height:16px;font-weight:500;color:var(--dsw-alias-label-tertiary,#81858c);cursor:pointer;transition:color .15s ease}
