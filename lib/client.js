...
header:has(> div[role='tablist']){display:flex;flex-direction:row;align-items:center;gap:24px;padding:8px 28px 8px 20px}
...
header:has(> div[role='tablist']) > div:first-child{order:2;display:flex;flex:none;align-items:center;gap:8px;min-height:0;margin-left:auto}
header:has(> div[role='tablist']) > div:first-child > div:first-child{flex:none}
`
