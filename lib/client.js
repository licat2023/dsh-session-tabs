...
header:has(> div[role='tablist']) > div:first-child{order:2;display:flex;flex:none;align-items:center;gap:8px;min-height:0;margin-left:auto;padding-bottom:11px}
