...
header:has(> div[role='tablist']){display:flex;flex-direction:row;align-items:flex-end;gap:24px;padding:2px 28px 0 20px}
...
header:has(> div[role='tablist']) > div:first-child{order:2;display:flex;flex:none;align-items:flex-end;gap:20px;min-height:0;margin-left:auto;padding-bottom:6px}
