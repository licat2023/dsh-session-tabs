...
header:has(> div[role='tablist']) > div:first-child button{padding:0;border:none;border-radius:0;background:transparent;font-size:13px;line-height:16px;color:var(--dsw-alias-label-tertiary,#81858c);cursor:pointer;transition:color .15s ease}
header:has(> div[role='tablist']) > div:first-child button:hover{color:var(--dsw-alias-state-business-primary,#679efe)}
`
